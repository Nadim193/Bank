...
namespace Bank.LoginDataBaseDataSetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Login] WHERE (([login_Id] = @Original_login_Id) AND ([User_nam" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Login] ([User_name], [Password]) VALUES (@User_name, @Password" +
                ");\r\nSELECT login_Id, User_name, Password FROM Login WHERE (login_Id = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Login] SET [User_name] = @User_name, [Password] = @Password WHERE (([login_Id] = @Original_login_Id) AND ([User_name] = @Original_User_name) AND ([Password] = @Original_Password));
SELECT login_Id, User_name, Password FROM Login WHERE (login_Id = @login_Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Bank.Properties.Settings.Default.LoginDataBaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT login_Id, User_name, Password FROM dbo.Login";
        ...
        public virtual int Fill(LoginDataBaseDataSet.LoginDataTable dataTable) {
        ...
        public virtual LoginDataBaseDataSet.LoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDataBaseDataSet.LoginDataTable dataTable = new LoginDataBaseDataSet.LoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataBaseDataSet.LoginDataTable dataTable) {
        ...
        public virtual int Delete(int Original_login_Id, string Original_User_name, string Original_Password) {
        ...
        public virtual int Update(string User_name, string Password, int Original_login_Id, string Original_User_name, string Original_Password, int login_Id) {
            if ((User_name == null)) {
                throw new global::System.ArgumentNullException("User_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string User_name, string Password, int Original_login_Id, string Original_User_name, string Original_Password) {
            return this.Update(User_name, Password, Original_login_Id, Original_User_name, Original_Password, Original_login_Id);
        }
    }
