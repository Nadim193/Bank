...
namespace Bank {
    ...
    public partial class bank_systemDataSet : global::System.Data.DataSet {
        ...
        public partial class logintblDataTable : global::System.Data.TypedTableBase<logintblRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public logintblRow AddlogintblRow(string User_Name, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public logintblRow FindBylogId(int logId) {
        ...
        public partial class logintblRow : global::System.Data.DataRow {
            ...
            public int logId {
                get {
                    return ((int)(this[this.tablelogintbl.logIdColumn]));
                }
                set {
                    this[this.tablelogintbl.logIdColumn] = value;
                }
            }
            ...
            public string User_Name {
                get {
                    return ((string)(this[this.tablelogintbl.User_NameColumn]));
                }
                set {
                    this[this.tablelogintbl.User_NameColumn] = value;
                }
            }
...
namespace Bank.bank_systemDataSetTableAdapters {
    ...
    public partial class logintblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `logintbl` WHERE ((`logId` = @p1) AND (`User Name` = @p2) AND (`Passw" +
                "ord` = @p3))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `logintbl` (`User Name`, `Password`) VALUES (@p1, @p2)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `logintbl` SET `User Name` = @p1, `Password` = @p2 WHERE ((`logId` = @p3) " +
                "AND (`User Name` = @p4) AND (`Password` = @p5))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Bank.Properties.Settings.Default.bank_systemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `logId`, `User Name`, `Password` FROM `logintbl`";
        ...
        public virtual int Fill(bank_systemDataSet.logintblDataTable dataTable) {
        ...
        public virtual bank_systemDataSet.logintblDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bank_systemDataSet.logintblDataTable dataTable = new bank_systemDataSet.logintblDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bank_systemDataSet.logintblDataTable dataTable) {
